...
export function getNftList() {
	return http.request({
		url: `${api.nftMarket}/api/goods`,
		method: 'GET'
	})
}

export function getMyNftListReq() {
	return http.request({
...
export function getNftDetailReq(params) {
	return http.request({
		url: `${api.nftMarket}/api/goods/info`,
		method: 'GET',
		params
	})
}
export function getNftOrderReq(params) {
	return http.request({
		url: `${api.nftMarket}/api/order/info`,
		method: 'GET',
		params
	})
}
...
export function buyNftReq(data) {
	return http.request({
		url: `${api.nftMarket}/api/goods/buy`,
		method: 'POST',
		data
	})
}
