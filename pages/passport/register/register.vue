	...
	<view class="wrapper">
			...
			<view class="input-wrapper">
				...
				<u-input :placeholder="$t('username')"
					class="input-style" focus v-model="userData.username" />
				...
				<u-input :placeholder="$t('inviteCode')"
					class="input-style" v-model="userData.inviteCode" />
				<view :class="!enableUserBtnColor ? 'disable' : 'fetch'" @click="passwordLogin" class="btn">
					{{$t('signup')}}
				</view>
			</view>
